...
/**
 * Función para extraer el ID del planeta de forma robusta
 */
...
/**
 * ApiExplorer Component (Explorador de Planetas SWAPI)
 * Consume el endpoint de planetas asíncronamente con estados de carga, error y paginación.
 * Complies strictly with University Rubric Requirement 5.
 */
export default function ApiExplorer() {
  ...
  useEffect(() => {
    ...
    // Fetch desde el mirror estable de planetas de SWAPI
  ...
  return (
    <section className="explorer-section fade-in">
      ...
      {/* Control de Estados con Estética Neón */}
      {loading ? (
        ...
        <>
          {/* Grilla de Resultados de Planetas */}
